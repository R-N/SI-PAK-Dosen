...
insert  into `batas_kategori`(`ID_JABATAN`,`ID_KATEGORI`,`MINIMAL`,`MAKSIMAL`) values 
(1,1,NULL,NULL),
(1,2,83,NULL),
(1,3,38,NULL),
(1,4,1,15),
...
insert  into `pak`(`ID_PAK`,`ID_PENILAI_1`,`ID_PENILAI_2`,`ID_JABATAN_TUJUAN`,`ID_PEMOHON`,`ID_JABATAN_AWAL`,`ID_STATUS_PAK`,`TANGGAL_STATUS`,`TANGGAL_DIAJUKAN`,`URL_SK`,`ID_SUBRUMPUN`,`ID_PENILAI_SUBMIT`,`NILAI_AWAL`,`NILAI_AKHIR`) values 
(1,3,NULL,2,3,1,1,'2019-11-21',NULL,NULL,1,NULL,NULL,NULL);
...
(5,2,'Melaksanakan perkuliahan/tutorial/\nperkuliahan praktikum dan membimbing,menguji serta menyelenggarakan pendidikan di laboratorium, praktik keguruan, bengkel/studio/kebun percobaan/\nteknologi pengajaran dan praktik lapangan (setiap semester) : Asisten Ahli untuk :  beban mengajar 2 sks berikutnya',NULL,NULL,1,0,'Pindai SK penugasan asli dan bukti kinerja',NULL),
...
(63,3,'Hasil penelitian atau hasil pemikiran yang didesiminasikan :',25,'%',5,0,NULL,NULL),
...
(65,3,'Hasil penelitian atau hasil pemikiran yang didesiminasikan : Dipresentasikan secara oral dan dimuat dalam prosiding yang dipublikasikan (ber ISSN/ISBN) : Internasional terindeks pada SCOPUS, IEEE Explore, SPIE',NULL,NULL,NULL,25,'Pindai halaman sampul, Panitia pelaksana, Panitia pengarah, daftar isi dan bukti kinerja',NULL),
(66,3,'Hasil penelitian atau hasil pemikiran yang didesiminasikan : Dipresentasikan secara oral dan dimuat dalam prosiding yang dipublikasikan (ber ISSN/ISBN) : Internasional',NULL,NULL,NULL,15,'Pindai halaman sampul, Panitia pelaksana, Panitia pengarah, daftar isi dan bukti kinerja',NULL),
(67,3,'Hasil penelitian atau hasil pemikiran yang didesiminasikan : Dipresentasikan secara oral dan dimuat dalam prosiding yang dipublikasikan (ber ISSN/ISBN) : Nasional',NULL,NULL,NULL,10,'Pindai halaman sampul, Panitia Pelaksana, Panitia pengarah, daftar isi dan bukti kinerja',NULL),
(68,3,'Hasil penelitian atau hasil pemikiran yang didesiminasikan : Disajikan dalam bentuk poster dan dimuat dalam prosiding yang dipublikasikan: Internasional',NULL,NULL,NULL,10,'Pindai poster, Panitia Pelaksana, Panitia Pengarah daftar isi dan buku panduan',NULL),
(69,3,'Hasil penelitian atau hasil pemikiran yang didesiminasikan : Disajikan dalam bentuk poster dan dimuat dalam prosiding yang dipublikasikan : Nasional',NULL,NULL,NULL,5,'Pindai poster, Panitia Pelaksana, Panitia pengarah, daftar isi dan bukun panduan',NULL),
(70,3,'Hasil penelitian atau hasil pemikiran yang didesiminasikan : Disajikan dalam seminar/simposium/ lokakarya, tetapi tidak dimuat dalam prosiding yang dipublikasikan : Internasional',NULL,NULL,NULL,5,'Pindai bukti kehadiran atau sertifikat dan bukti kinerja, Panitia',NULL),
(71,3,'Hasil penelitian atau hasil pemikiran yang didesiminasikan : Disajikan dalam seminar/simposium/ lokakarya, tetapi tidak dimuat dalam prosiding yang dipublikasikan : Nasional',NULL,NULL,NULL,3,'Pindai bukti kehadiran atau sertifikat dan bukti kinerja',NULL),
(72,3,'Hasil penelitian atau hasil pemikiran yang didesiminasikan : Hasil penelitian/pemikiran yang tidak disajikan dalam seminar/simposium/ lokakarya, tetapi dimuat dalam prosiding : Internasional',NULL,NULL,NULL,10,'Pindai halaman sampul, daftar isi makalah, dan bukti kinerja',NULL),
(73,3,'Hasil penelitian atau hasil pemikiran yang didesiminasikan : Hasil penelitian/pemikiran yang tidak disajikan dalam seminar/simposium/ lokakarya, tetapi dimuat dalam prosiding : Nasional',NULL,NULL,NULL,5,'Pindai halaman sampul, daftar isi makalah, dan bukti kinerja',NULL),
(74,3,'Hasil penelitian atau hasil pemikiran yang didesiminasikan : Hasil penelitian/pemikiran yang disajikan dalam koran/majalah populer/umum',5,'%',6,1,'Pindai halaman sampul dan bukti kinerja',NULL),
(75,3,'Hasil penelitian atau pemikiran atau kerjasama industri yang tidak dipublikasikan (tersimpan dalam perpustakaan) yang dilakukan secara melembaga',5,'%',6,2,'Pindai halaman sampul, daftar isi, lembar pengesahan dan bukti kinerja',NULL),
(76,3,'Menerjemahkan/menyadur buku ilmiah yang diterbitkan (ber ISBN)',NULL,NULL,NULL,15,'Pindai halaman sampul dan bukti kinerja yang dapat diakses oleh asesor',NULL),
(77,3,'Mengedit/menyunting karya ilmiah dalam bentuk buku yang diterbitkan (ber ISBN)',NULL,NULL,NULL,10,'Pindai halaman sampul dan bukti kinerja yang dapat diakses oleh asesor',NULL),
(78,3,'Membuat rancangan dan karya teknologi yang dipatenkan atau seni yang terdaftar di HaKI secara nasional atau internasional : Internasional yang sudah diimplementasikan di industri (paling sedikit diakui oleh 4 Negara)',NULL,NULL,NULL,60,'Pindai bukti kinerja dan sertifikat paten',NULL),
(79,3,'Membuat rancangan dan karya teknologi yang dipatenkan atau seni yang terdaftar di HaKI secara nasional atau internasional : Internasional (paling sedikit diakui oleh 4 Negara)',NULL,NULL,NULL,50,'Pindai bukti kinerja dan sertifikat paten',NULL),
(80,3,'Membuat rancangan dan karya teknologi yang dipatenkan atau seni yang terdaftar di HaKI secara nasional atau internasional : Nasional (yang sudah diimplementasikan di industri)',NULL,NULL,NULL,40,'Pindai bukti kinerja dan sertifikat paten',NULL),
(81,3,'Membuat rancangan dan karya teknologi yang dipatenkan atau seni yang terdaftar di HaKI secara nasional atau internasional : Nasional',NULL,NULL,NULL,30,'Pindai bukti kinerja dan sertifikat paten',NULL),
...
(108,4,'Memberi latihan/penyuluhan/ penataran/ceramah pada masyarakat, terjadwal/terprogram : Dalam satu semester atau lebih :  Tingkat Nasional, tiap program',NULL,NULL,NULL,3,NULL,NULL),
(109,4,'Memberi latihan/penyuluhan/ penataran/ceramah pada masyarakat, terjadwal/terprogram : Dalam satu semester atau lebih :  Tingkat Lokal, tiap program',NULL,NULL,NULL,2,NULL,NULL),
(110,4,'Memberi latihan/penyuluhan/ penataran/ceramah pada masyarakat, terjadwal/terprogram : Kurang dari satu semester dan minimal satu bulan : Tingkat Internasional tiap program',NULL,NULL,NULL,3,NULL,NULL),
(111,4,'Memberi latihan/penyuluhan/ penataran/ceramah pada masyarakat, terjadwal/terprogram : Kurang dari satu semester dan minimal satu bulan : Tingkat Nasional, tiap program',NULL,NULL,NULL,2,NULL,NULL),
(112,4,'Memberi latihan/penyuluhan/ penataran/ceramah pada masyarakat, terjadwal/terprogram : Kurang dari satu semester dan minimal satu bulan : Tingkat Lokal, tiap program',NULL,NULL,NULL,1,NULL,NULL),
(113,4,'Memberi latihan/penyuluhan/ penataran/ceramah pada masyarakat, terjadwal/terprogram : Kurang dari satu semester dan minimal satu bulan : Insidental, tiap kegiatan/program',NULL,NULL,NULL,1,NULL,NULL),
(114,4,'Memberi pelayanan kepada masyarakat atau kegiatan lain yang menunjang pelaksanaan tugas pemerintahan dan pembangunan : Berdasarkan bidang keahlian, tiap program',NULL,NULL,NULL,2,NULL,NULL),
(115,4,'Memberi pelayanan kepada masyarakat atau kegiatan lain yang menunjang pelaksanaan tugas pemerintahan dan pembangunan :  Berdasarkan penugasan lembaga terguruan tinggi, tiap program',NULL,NULL,NULL,1,NULL,NULL),
(116,4,'Memberi pelayanan kepada masyarakat atau kegiatan lain yang menunjang pelaksanaan tugas pemerintahan dan pembangunan :  Berdasarkan fungsi/jabatan tiap program',NULL,NULL,NULL,1,NULL,NULL),
(117,4,'Membuat/menulis karya pengabdian pada masyarakat yang tidak dipublikasikan,tiap karya',NULL,NULL,NULL,3,NULL,NULL),
(118,4,'Hasil kegiatan pengabdian kepada masyarakat yang dipublikasikan di sebuah berkala/jurnal pengabdian kepada masyarakat atau teknologi tepat guna, merupakan diseminasi dari luaran program kegiatan pengabdian kepada masyarakat, tiap karya',NULL,NULL,NULL,5,NULL,NULL),
(119,4,'Berperan serta aktif dalam pengelolaan jurnal ilmiah (per tahun)* : Editor/dewan penyunting/dewan redaksi jurnal ilmiah internasional (Diakui satu jurnal)',NULL,NULL,NULL,1,NULL,NULL),
(120,4,'Berperan serta aktif dalam pengelolaan jurnal ilmiah (per tahun)* :  Editor/dewan penyunting/dewan redaksi jurnal ilmiah nasional (Diakui satu jurnal)',NULL,NULL,NULL,1,NULL,NULL),
(121,5,'Menjadi anggota dalam suatu Panitia/Badan pada Perguruan Tinggi  sebagai Ketua/Wakil Ketua merangkap Anggota, tiap tahun',NULL,NULL,NULL,3,NULL,NULL),
(122,5,'Menjadi anggota dalam suatu Panitia/Badan pada Perguruan Tinggi sebagai Anggota, tiap tahun',NULL,NULL,NULL,2,NULL,NULL),
(123,5,'Menjadi anggota panitia/badan pada lembaga pemerintah  panitia pusat, sebagai Ketua/Wakil Ketua, tiap kepanitiaan',NULL,NULL,NULL,3,NULL,NULL),
(124,5,'Menjadi anggota panitia/badan pada lembaga pemerintah  panitia pusat, sebagai Anggota, tiap kepanitiaan',NULL,NULL,NULL,2,NULL,NULL),
(125,5,'Menjadi anggota panitia/badan pada lembaga pemerintah panitia daerah, sebagai Ketua/Wakil Ketua, tiap kepanitiaan',NULL,NULL,NULL,2,NULL,NULL),
(126,5,'Menjadi anggota panitia/badan pada lembaga pemerintah panitia daerah, sebagai Anggota, tiap kepanitiaan',NULL,NULL,NULL,1,NULL,NULL),
(127,5,'Menjadi anggota organisasi profesi Tingkat Internasional, sebagai :  Pengurus, tiap periode jabatan pengurus merangkap anggota',NULL,NULL,NULL,2,NULL,NULL),
(128,5,'Menjadi anggota organisasi profesi Tingkat Internasional, sebagai :  Anggota atas permintaan, tiap periode jabatan',NULL,NULL,NULL,1,NULL,NULL),
(129,5,'Menjadi anggota organisasi profesi Tingkat Internasional, sebagai : Anggota, tiap periode jabatan',NULL,NULL,NULL,1,NULL,NULL),
(130,5,'Menjadi anggota organisasi profesi Tingkat Nasional, sebagai :  Pengurus, tiap periode jabatan',NULL,NULL,NULL,2,NULL,NULL),
(131,5,'Menjadi anggota organisasi profesi Tingkat Nasional, sebagai : Anggota, atas permintaan, tiap periode jabatan',NULL,NULL,NULL,1,NULL,NULL),
(132,5,'Menjadi anggota organisasi profesi Tingkat Nasional, sebagai : Anggota, tiap periode jabatan',NULL,NULL,NULL,1,NULL,NULL),
(133,5,'Mewakili Perguruan Tinggi/Lembaga Pemerintah duduk dalam Panitia Antar Lembaga, tiap kepanitiaan',NULL,NULL,NULL,1,NULL,NULL),
(134,5,'Menjadi anggota delegasi Nasional ke pertemuan Internasional Sebagai Ketua delegasi, tiap kegiatan',NULL,NULL,NULL,3,NULL,NULL),
(135,5,'Menjadi anggota delegasi Nasional ke pertemuan Internasional Sebagai Anggota, tiap kegiatan',NULL,NULL,NULL,2,NULL,NULL),
(136,5,'Berperan serta aktif dalam pertemuan ilmiah tingkat Internasional/Nasional/Regional sebagai : Ketua, tiap kegiatan',NULL,NULL,NULL,3,NULL,NULL),
(137,5,'Berperan serta aktif dalam pertemuan ilmiah Tingkat Internasional/Nasional/Regional sebagai : Anggota/peserta, tiap kegiatan',NULL,NULL,NULL,2,NULL,NULL),
(138,5,'Berperan serta aktif dalam pertemuan ilmiah Di lingkungan Perguruan Tinggi sebagai :  Ketua, tiap kegiatan',NULL,NULL,NULL,2,NULL,NULL),
(139,5,'Berperan serta aktif dalam pertemuan ilmiah Di lingkungan Perguruan Tinggi sebagai :  Anggota/peserta, tiap kegiatan',NULL,NULL,NULL,1,NULL,NULL),
(140,5,'Mendapat tanda jasa/penghargaan : Penghargaan/tanda jasa Satya lencana 30 tahun',NULL,NULL,NULL,3,NULL,NULL),
(141,5,'Mendapat tanda jasa/penghargaan : Penghargaan/tanda jasa Satya lencana 20 tahun',NULL,NULL,NULL,2,NULL,NULL),
(142,5,'Mendapat tanda jasa/penghargaan : Penghargaan/tanda jasa Satya lencana 10 tahun',NULL,NULL,NULL,1,NULL,NULL),
(143,5,'Mendapat tanda jasa/penghargaan : Tingkat Internasional, tiap tanda jasa/penghargaan',NULL,NULL,NULL,5,NULL,NULL),
(144,5,'Mendapat tanda jasa/penghargaan : Tingkat Nasional, tiap tanda jasa/penghargaan',NULL,NULL,NULL,3,NULL,NULL),
(145,5,'Mendapat tanda jasa/penghargaan :  Tingkat Daerah/Lokal, tiap tanda jasa/penghargaan',NULL,NULL,NULL,1,NULL,NULL),
(146,5,'Menulis buku pelajaran SLTA ke bawah yang diterbitkan dan diedarkan secara nasional :  Buku SMTA atau setingkat, tiap buku',NULL,NULL,NULL,5,NULL,NULL),
(147,5,'Menulis buku pelajaran SLTA ke bawah yang diterbitkan dan diedarkan secara nasional :  Buku SMTP atau setingkat, tiap buku',NULL,NULL,NULL,5,NULL,NULL),
(148,5,'Menulis buku pelajaran SLTA ke bawah yang diterbitkan dan diedarkan secara nasional :   Buku SD atau setingkat, tiap buku',NULL,NULL,NULL,5,NULL,NULL),
(149,5,'Mempunyai prestasi di bidang olahraga/ Humaniora : Tingkat Internasional, tiap piagam/medali',NULL,NULL,NULL,5,NULL,NULL),
(150,5,'Mempunyai prestasi di bidang olahraga/ Humaniora : Tingkat Nasional, tiap piagam/medali',NULL,NULL,NULL,3,NULL,NULL),
(151,5,'Mempunyai prestasi di bidang olahraga/ Humaniora : Tingkat Daerah/Lokal, tiap piagam/medali',NULL,NULL,NULL,1,NULL,NULL),
(152,5,'Keanggotaan dalam tim penilai jabatan akademik dosen',NULL,NULL,NULL,1,NULL,NULL);
